...
class AccountInvoice(models.Model):
    ...
    def _default_journal(self):
        _logger.debug('_default_journal') 
    ...
    def _get_reference_type(self):
        _logger.debug('_get_reference_type') 
    ...
    def _compute_residual(self):
        _logger.debug('_compute_residual') 
        residual = 0.0
    ...
    def _get_outstanding_info_JSON(self):
        _logger.debug('_get_outstanding_info_JSON') 
    ...
    def _get_payment_info_JSON(self):
        _logger.debug('_get_payment_info_JSON') 
    ...
    def _compute_payments(self):
        _logger.debug('_compute_payments') 
        payment_lines = []
    ...
    def action_invoice_sent(self):
        _logger.debug('action_invoice_sent') 
    ...
    def confirm_paid(self):
        _logger.debug('confirm_paid') 
        return self.write({'state': 'paid'})

    @api.multi
    def unlink(self):
        _logger.debug('unlink') 
        for invoice in self:
    ...
    def _onchange_invoice_line_ids(self):
        _logger.debug('_onchange_invoice_line_ids') 
    ...
    def _onchange_partner_id(self):
        _logger.debug('_onchange_partner_id') 
        account_id = False
    ...
    def action_cancel_draft(self):
        _logger.debug('action_cancel_draft') 
    ...
    def register_payment(self, payment_line, writeoff_acc_id=False, writeoff_journal_id=False):
        _logger.debug('register_payment') 
    ...
    def assign_outstanding_credit(self, cr, uid, id, credit_aml_id, context=None):
        _logger.debug('assign_outstanding_credit') 
    ...
    def action_date_assign(self):
        _logger.debug('action_date_assign') 
        for inv in self:
    ...
    def finalize_invoice_move_lines(self, move_lines):
        _logger.debug('finalize_invoice_move_lines') 
    ...
    def compute_invoice_totals(self, company_currency, invoice_move_lines):
        _logger.debug('compute_invoice_totals') 
        total = 0
        total_currency = 0
    ...
    def invoice_line_move_line_get(self):
        _logger.debug('invoice_line_move_line_get') 
        res = []
        for line in self.invoice_line_ids:
            tax_ids = []
    ...
    def tax_line_move_line_get(self):
        _logger.debug('tax_line_move_line_get') 
        res = []
    ...
    def inv_line_characteristic_hashcode(self, invoice_line):
        _logger.debug('inv_line_characteristic_hashcode') 
    ...
    def action_move_create(self):
        _logger.debug('action_move_create') 
    ...
    def invoice_validate(self):
        _logger.debug('invoice_validate') 
        for invoice in self:
    ...
    def line_get_convert(self, line, part):
        _logger.debug('line_get_convert') 
        return {
    ...
    def _refund_cleanup_lines(self, lines):
        _logger.debug('_refund_cleanup_lines')
    ...
    def pay_and_reconcile(self, pay_journal, pay_amount=None, date=None, writeoff_acc=None):
        _logger.debug('pay_and_reconcile')
    ...
    def _get_tax_amount_by_group(self):
        _logger.debug('_get_tax_amount_by_group')
        self.ensure_one()
        res = {}
    ...
    def _notification_group_recipients(self, message, recipients, done_ids, group_data):
        _logger.debug('_notification_group_recipients')
