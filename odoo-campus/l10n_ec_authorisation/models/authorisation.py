...
class AccountAuthorisation(models.Model):
    ...
    def create(self, values):
        ...
        if values.get('partner_id', False) and values['partner_id'] == partner_id:  # noqa
            ...
            #JSA. Problemas. "ir.sequence.type does" not exist in version 9.0 Odoo
            ...
            code_str = '{0}.{1}.{2}'.format(name_type, values['serie_entidad'],values['serie_emision'])
...
class AccountInvoice(models.Model):
    ...
    """
    JSA. Este metodo, causa, que al momento de seleccionar el partner no se establece la cuenta.
    ...
    """        
    JSA: No utilizar el campo reference para numero de factura, utilizar un campo diferente. Campo adicionado en el modulo campus_invoice "supplier_invoice_number"
